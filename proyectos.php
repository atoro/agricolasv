...
<section class="contenido_nosotros">
  <div class="centro_nosotros">
    ...
    <article>
      ...
      <div class="texto">
        <h2><?php $texto = str_replace("\r\n","<br>",$rs["titulo_proyecto"]); echo $texto ?></h2>
        <p><?php $texto = str_replace("\r\n","<br>",$rs["breve_proyecto"]); echo $texto ?></p>
        <a class="a" href="detalleproyecto.php?id=<?php echo $rs["id"]; ?>">VER MAS</a>
      </div>
    </article>
    <?php } ?>
  </div>
...
<section id="contacto">
  <div class="centro_contacto">
    ...
    <form action="proyectos.php" method="post" onSubmit="MM_validateForm('name','','R','message','','R');return document.MM_returnValue;return document.MM_returnValue">
