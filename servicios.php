...
<head>
  ...
  <title>Servicios AIT SV Ltda</title>
  ...
  <div class="centro_nosotros">
    ...
    <article>
      ...
      <div class="texto">
        ...
        <p><?php $texto = str_replace("\r\n","<br>",$rs["contenido_servicio"]); echo $texto ?></p>
      </div>
    </article>
    <?php } ?>
  </div>
...
<section id="contacto">
  <div class="centro_contacto">
    ...
    <form action="servicios.php" method="post" onSubmit="MM_validateForm('name','','R','message','','R');return document.MM_returnValue;return document.MM_returnValue">
