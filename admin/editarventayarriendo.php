...
<form action="editarventayarriendo.php?id=<?php echo $_GET["id"]; ?>" method="post" name="form1" id="form1">
    ...
    <tr>
      <td width="81%" valign="top"><p>
        ...
        <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="22" align="right" valign="top" class="textos"><span class="texto">Nombre :</span>&nbsp;</td>
            <td valign="top" class="Letras1"><input name="nombre" type="text" id="titulo_noticia10" value="<?php echo $rs["nombre"]; ?>" /></td>
          </tr>
          <tr>
            <td height="23" align="right" valign="top" class="textos"><span class="texto">Tipo :</span>&nbsp;</td>
          ...
          <tr>
            <td height="22" align="right" valign="top" class="textos"><span class="texto">Sector :</span>&nbsp;</td>
            <td valign="top" class="Letras1"><input name="sector" type="text" id="titulo_noticia8" value="<?php echo $rs["sector"]; ?>" /></td>
          </tr>
          <tr>
            <td height="22" align="right" valign="top" class="textos"><span class="texto">Superficie Terreno:</span>&nbsp;</td>
          ...
          <tr>
            <td height="22" align="right" valign="top" class="textos"><span class="texto">Superficie Construida :</span>&nbsp;</td>
          ...
          <tr>
            <td height="22" align="right" valign="top" class="textos"><span class="Letras1"><span class="titulos">Region :</span><span class="texto"><strong> &nbsp;</strong></span></span></td>
            <td valign="top" class="Letras1"><select name="region" class="combobox" id="primerCombo" onchange="SeleccionandoCombo(this, 'segundoCombo');">
              <?php 
    $listadoerr = "select * from region  where idregion = '$rs[region]'  ";
  ...
  ?>
          ...
          <tr>
            <td height="22" align="right" valign="top" class="textos"><span class="Letras1"><span class="titulos">Comuna :</span><span class="texto"><strong> &nbsp; </strong></span></span></td>
            <td valign="top" class="Letras1"><select name="comuna" class="select" id="comuna">
              <?php 
    $listadorr = "select * from comuna  where id = '$rs[comuna]'  ";
  ...
  ?>
          ...
          <tr>
            <td height="22" align="right" valign="top" class="textos"><span class="texto">Pisos :</span>&nbsp;</td>
            <td valign="top" class="Letras1"><input name="pisos" type="text" id="titulo_noticia5" value="<?php echo $rs["pisos"]; ?>" /></td>
          </tr>
          <tr>
            <td height="22" align="right" valign="top" class="textos"><span class="texto">Dormitorios :</span>&nbsp;</td>
            <td valign="top" class="Letras1"><input name="dormitorios" type="text" id="titulo_noticia4" value="<?php echo $rs["dormitorios"]; ?>" /></td>
          </tr>
          <tr>
            <td height="22" align="right" valign="top" class="textos"><span class="texto">Baños :</span>&nbsp;</td>
            <td valign="top" class="Letras1"><input name="banos" type="text" id="titulo_noticia3" value="<?php echo $rs["banos"]; ?>" /></td>
          </tr>
          <tr>
            <td width="31%" height="22" align="right" valign="top" class="textos"><span class="texto">Estacionamientos :</span>&nbsp;</td>
          ...
          <tr>
            <td height="82" valign="top" class="textobox"><div align="right" class="titulo"><span class="textos"><span class="texto">Otros </span>:&nbsp;</span></div></td>
          ...
          <tr>
            <td height="22" align="right" valign="top" class="textos"><span class="texto">Precio :</span>&nbsp;</td>
            <td valign="top" class="Letras1"><input name="precio" type="text" id="titulo_noticia12" value="<?php echo $rs["precio"]; ?>" /></td>
          </tr>
          <tr>
            <td height="82" valign="top" class="textobox"><div align="right" class="titulo"><span class="textos"><span class="texto">Descripcion Corta </span>:&nbsp;</span></div></td>
            <td valign="top" class="Letras1"><span class="textobox">
              <textarea name="descripcion_corta" cols="40" rows="5" class="Letras1" id="breve_noticia"><?php echo $rs["descripcion_corta"]; ?></textarea>
            </span></td>
          </tr>
          <tr>
            <td height="82" valign="top" class="textobox"><div align="right" class="titulo"><span class="textos"><span class="texto">Descripcion Larga</span>:&nbsp;</span></div></td>
            <td valign="top" class="Letras1"><span class="textobox">
          ...
          <tr>
            ...
            <td valign="top" class="Letras1"><textarea name="mapa" cols="40" rows="5" id="titulo_noticia14"><?php echo $rs["mapa"]; ?></textarea></td>
          </tr>
          <tr>
